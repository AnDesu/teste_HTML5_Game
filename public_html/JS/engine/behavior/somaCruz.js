...
//    node_movmntElement0.setAttribute('data-position_pos_y', document.getElementById(node_movmntElement0.dataset.movement_linkedobject_id_0).style.top);
    node_movmntElement0.setAttribute('data-movement_tomove_x', document.getElementById(node_movmntElement0.dataset.movement_linkedobject_id_0).style.left);
    node_movmntElement0.setAttribute('data-movement_tomove_y', document.getElementById(node_movmntElement0.dataset.movement_linkedobject_id_0).style.top);
    node_movmntElement0.setAttribute('data-position_pos_x', '-1px');
    node_movmntElement0.setAttribute('data-position_pos_y', '-1px');
...
//    movmntElement0.setAttribute('data-position_pos_y', document.getElementById(movmntElement0.dataset.movement_linkedobject_id_0).style.top);
    ...
    if (gameArrowUp > 0)
    {
        movmntElement0.dataset.movement_tomove_y = (parseInt(movmntElement0.dataset.movement_tomove_y) - 3) + "px";
    }
    if (gameArrowDown > 0)
    {
        movmntElement0.dataset.movement_tomove_y = (parseInt(movmntElement0.dataset.movement_tomove_y) + 3) + "px";
    ...
    if (gameArrowRight > 0)
    {
        movmntElement0.dataset.movement_tomove_x = (parseInt(movmntElement0.dataset.movement_tomove_x) + 3) + "px";
    }
    if (gameArrowLeft > 0)
    {
        movmntElement0.dataset.movement_tomove_x = (parseInt(movmntElement0.dataset.movement_tomove_x) - 3) + "px";
